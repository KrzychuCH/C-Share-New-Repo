...
namespace FirstWMS {
    ...
    public partial class Users : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string Login, string Name, int Active, byte[] Password) {
            ...
            public int Active {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'Active\' w tabeli \'Users\' to DBNull.", e);
                    }
                }
                set {
...
namespace FirstWMS.UsersTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([id] = @Original_id) AND ((@IsNull_Login = 1 AND [Login] IS NULL) OR ([Login] = @Original_Login)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Login], [Name], [Active], [Password]) VALUES (@Login," +
                " @Name, @Active, @Password);\r\nSELECT id, Login, Name, Active, Password FROM User" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Login] = @Login, [Name] = @Name, [Active] = @Active, [Password] = @Password WHERE (([id] = @Original_id) AND ((@IsNull_Login = 1 AND [Login] IS NULL) OR ([Login] = @Original_Login)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT id, Login, Name, Active, Password FROM Users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FirstWMS.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Login, Name, Active, Password FROM dbo.Users";
        ...
        public virtual int Delete(int Original_id, string Original_Login, string Original_Name, global::System.Nullable<int> Original_Active, byte[] Original_Password) {
            ...
            if ((Original_Password == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((byte[])(Original_Password));
            }
        ...
        public virtual int Insert(string Login, string Name, global::System.Nullable<int> Active, byte[] Password) {
            if ((Login == null)) {
        ...
        public virtual int Update(string Login, string Name, global::System.Nullable<int> Active, byte[] Password, int Original_id, string Original_Login, string Original_Name, global::System.Nullable<int> Original_Active, byte[] Original_Password, int id) {
            if ((Login == null)) {
            ...
            if ((Original_Active.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_Active.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Login, string Name, global::System.Nullable<int> Active, byte[] Password, int Original_id, string Original_Login, string Original_Name, global::System.Nullable<int> Original_Active, byte[] Original_Password) {
            return this.Update(Login, Name, Active, Password, Original_id, Original_Login, Original_Name, Original_Active, Original_Password, Original_id);
        }
    }
